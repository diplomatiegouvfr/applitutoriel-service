...
CREATE TABLE CIVILITE (
    ID_CIVILITE INTEGER PRIMARY KEY
...
CREATE TABLE SECTEUR (
    ...
    , SEC_DATE_CREAT DATETIME
    , SEC_AUTEUR_CREAT VARCHAR(10)
    , SEC_DATE_MAJ DATETIME
    , SEC_AUTEUR_MAJ VARCHAR(10)
    , SEC_DATE_SUPPR DATETIME NULL
...
CREATE TABLE PARTENAIRE (
    ID_PARTENAIRE INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY
    , ID_VILLE INTEGER NOT NULL
    , ID_CIVILITE INTEGER NOT NULL
    , ID_PAYS INTEGER NOT NULL
    , ID_PHOTO INTEGER NULL
    , PAR_IS_CLIENT BOOLEAN DEFAULT 0
    , PAR_IS_VIP BOOLEAN DEFAULT 0
    , PAR_NOM VARCHAR(50)
    , PAR_PRENOM VARCHAR(50)
    , PAR_NOM_LOCAL VARCHAR(50) NULL
    , PAR_PRENOM_LOCAL VARCHAR(50) NULL
    , PAR_DATE_NAISSANCE DATETIME NULL
    ...
    , PAR_DATE_MODIFICATION DATETIME NULL
